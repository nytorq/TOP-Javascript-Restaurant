...
function aboutContent() {
    ...
    let contentFragment = textCreator("h2", "About us");
    ...
    content.appendChild(contentFragment);
    contentFragment = imageCreator(gastronomiaInterior, "An inviting image of the restaurant's interior, showcasing a cozy, modern dining area with warm lighting, wooden furniture, and elegant table settings");
    content.appendChild(contentFragment);
    return content;
}
